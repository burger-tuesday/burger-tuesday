package rocks.burgertuesday.app.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(rocks.burgertuesday.app.repository..*)" +
            " || within(rocks.burgertuesday.app.service..*)" +
            " || within(rocks.burgertuesday.app.web.rest..*)"
    )
